...
@WebServlet("/deletecount.action")
public class DeleteCountAction extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(idStr!=null){
            ...
            boolean flag= countService.delete(id);
            if(flag){
                //成功，转到房间类型action
                resp.sendRedirect("countmanage.action");
            }else{
                //转发到错误页面
